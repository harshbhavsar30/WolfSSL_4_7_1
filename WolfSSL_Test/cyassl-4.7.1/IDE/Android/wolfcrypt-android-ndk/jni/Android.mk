...
LOCAL_CFLAGS            := -DNO_DSA -DNO_PSK -DNO_MD4 -DNO_HC128 \
						   ...
						   -DWOLFSSL_PUB_PEM_TO_DER -DHAVE_RSA4096_SUPPORT -DHAVE_PKCS7 -DHAVE_X963_KDF -DOPENSSL_EXTRA\
						   ...
						   -DWOLFSSL_SP_ASM -DHAVE_EX_DATA -DWOLFSSL_AES_COUNTER -DWOLFSSL_EVP_INCLUDED -DOPENSSL_ALL -Wall -Wno-unused -O1
...
include $(CLEAR_VARS)
LOCAL_PATH       := $(TOP_PATH)/../wolfmikey-0.20.3/
